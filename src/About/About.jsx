        ...
        <div className='bg-white'>
            ...
            <div className='max-w-[1140px] mx-auto'>
                <div>
                    ...
                    <div className='flex'>
                        <div>
                            <img src={papercut1} alt="" />
                        </div>
                        <div>
                            <p>SR DREAM IT is an online-based platform of DIGITAL MARKETING Training. SR DREAM IT trained 3000+ Students and most are successful In both online and offline marketplace. From last year, the combined earnings of our students reached $600000+ almost. We always provide our best for making our students learn and develop their working skills. If you do your best then we will be always by your side to support you to be successful.</p>
                            <p>In 2020 SR DREAM IT started it’s journey where the main concern was to develop the skills of it’s trainees which are on top of the market demand. We worked so hard that now SR DREAM IT is one of the most successful training institutes in Bangladesh with all 100% positive feedback submitted by our students all over Bangladesh.</p>
                        </div>
                    </div>
                </div>
            </div>
